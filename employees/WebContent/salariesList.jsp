...
<div class="container">
	...
	<%
		...
		String sql = "select emp_no, salary, from_date, to_date from salaries order by emp_no limit ?,?";
		String sql2 = "select count(*) as cnt from salaries";
	...
	%>
		...
		%>		
			...
			if(currentPage != lastPage){
			%>
				<a href="./salariesList.jsp?currentPage=<%=lastPage %>">끝으로</a>
			<%
				}
			%>
	</div>
